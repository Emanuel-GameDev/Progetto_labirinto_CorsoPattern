...
public class FunctionsList : Dictionary<string, List<Action<object>>> { }
...
public class PubSub : MonoBehaviour
{
    ...
    public void RegisterFunction(string messageType, Action<object> function)
    {
    ...
    public void Notify(string messageType, object messageContent)
    {
